...
@generated function simd(state::State{T}, cutoff::T, ::Type{Val{Forces}}, ::Type{Vec{N,T}}) where {Forces, N, T<:AbstractFloat}
    ...
    quote
        ...
        remaining_mask = Vec{4, Float32}((1, 1, 1, 0))
...
@generated function simd(state::State{T}, vlist::VerletList, ::Type{Val{Forces}}, ::Type{Vec{N,T}}) where {Forces, N, T<:AbstractFloat}
    ...
    quote
        ...
        @inbounds for i = 1:natoms-1
            ...
            for j = ptr:ptr_stop
                ...
                # println("j: $j1 $i1")
                # println("vj: $(vload(Vec{4,T}, coords, j1))")
                # println("vi: $vi")
